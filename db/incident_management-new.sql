...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 27, 2026 at 08:41 AM
...
(261, 2, 'LOGIN', 'users', 2, '2026-02-27 06:46:15'),
(262, 2, 'UPDATE', 'incident_reports', 29, '2026-02-27 06:46:33'),
(263, 2, 'LOGOUT', 'users', 2, '2026-02-27 06:46:37'),
(264, 2, 'LOGIN', 'users', 2, '2026-02-27 06:47:33'),
(265, 2, 'LOGOUT', 'users', 2, '2026-02-27 06:51:08'),
(266, 1, 'LOGIN', 'users', 1, '2026-02-27 06:51:14'),
(267, 1, 'LOGOUT', 'users', 1, '2026-02-27 06:55:24'),
(268, 2, 'LOGIN', 'users', 2, '2026-02-27 06:55:30'),
(269, 2, 'UPDATE', 'incident_reports', 31, '2026-02-27 07:00:10'),
(270, 1, 'LOGIN', 'users', 1, '2026-02-27 07:16:13'),
(271, 1, 'LOGOUT', 'users', 1, '2026-02-27 07:22:59'),
(272, 2, 'LOGIN', 'users', 2, '2026-02-27 07:23:05'),
(273, 2, 'LOGIN', 'users', 2, '2026-02-27 07:43:50'),
(274, 2, 'UPDATE', 'organization_members', 1, '2026-02-27 07:58:26'),
(275, 2, 'LOGOUT', 'users', 2, '2026-02-27 07:58:35'),
(276, 2, 'LOGIN', 'users', 2, '2026-02-27 08:00:24'),
(277, 2, 'LOGOUT', 'users', 2, '2026-02-27 08:00:52'),
(278, 1, 'LOGIN', 'users', 1, '2026-02-27 08:03:18'),
(279, 1, 'LOGOUT', 'users', 1, '2026-02-27 08:03:22'),
(280, 2, 'LOGIN', 'users', 2, '2026-02-27 08:16:21'),
(281, 2, 'CREATE', 'organization_members', 1, '2026-02-27 08:19:31'),
(282, 2, 'LOGOUT', 'users', 2, '2026-02-27 08:19:40'),
(283, 2, 'LOGIN', 'users', 2, '2026-02-27 08:20:25'),
(284, 2, 'UPDATE', 'incident_reports', 32, '2026-02-27 08:21:00'),
(285, 2, 'LOGOUT', 'users', 2, '2026-02-27 08:21:46'),
(286, 2, 'LOGIN', 'users', 2, '2026-02-27 08:23:19'),
(287, 2, 'LOGOUT', 'users', 2, '2026-02-27 08:23:29'),
(288, 2, 'LOGIN', 'users', 2, '2026-02-27 08:25:31'),
(289, 2, 'CREATE', 'organization_members', 2, '2026-02-27 08:26:14'),
(290, 2, 'LOGOUT', 'users', 2, '2026-02-27 08:26:31'),
(291, 17, 'LOGIN', 'users', 17, '2026-02-27 08:26:38'),
(292, 17, 'CREATE', 'incident_updates', 55, '2026-02-27 08:33:54'),
(293, 17, 'LOGOUT', 'users', 17, '2026-02-27 08:34:56'),
(294, 2, 'LOGIN', 'users', 2, '2026-02-27 08:35:05'),
(295, 2, 'LOGOUT', 'users', 2, '2026-02-27 08:38:49'),
(296, 17, 'LOGIN', 'users', 17, '2026-02-27 08:39:16');
...
(21, 30, 'uploads/incident_30_1772174746_0.jpeg', '2026-02-27 06:45:46'),
(22, 31, 'uploads/incident_31_1772174840_0.png', '2026-02-27 06:47:20'),
(23, 32, 'uploads/incident_32_1772180416_0.jpeg', '2026-02-27 08:20:16');
...
INSERT INTO `incident_reports` (`id`, `title`, `description`, `incident_date`, `incident_time`, `location`, `latitude`, `longitude`, `severity_level`, `category`, `reported_by`, `reporter_contact_number`, `family_contact_name`, `family_contact_number`, `organization_id`, `status`, `resolution_notes`, `created_at`) VALUES
(1, 'Kitchen Fire at Restaurant', 'Small grease fire in the kitchen area of downtown restaurant. Fire was contained quickly but caused smoke damage.', '2024-01-15', '14:30:00', '123 Main Street, Downtown', NULL, NULL, 'Medium', 'Fire', '5', NULL, NULL, NULL, 3, 'Resolved', NULL, '2025-09-17 05:43:56'),
(2, 'Traffic Accident on Highway', 'Two-vehicle collision on Interstate 95. Minor injuries reported, vehicles blocking two lanes.', '2024-01-16', '08:45:00', 'Interstate 95, Mile Marker 42', NULL, NULL, 'High', 'Accident', '0', NULL, NULL, NULL, 2, 'Resolved', NULL, '2025-09-17 05:43:56'),
(3, 'Patient Fall in Hospital', 'Elderly patient fell in hallway near room 205. No serious injuries but requires medical attention.', '2024-01-17', '10:15:00', 'City General Hospital, 2nd Floor', NULL, NULL, 'Low', 'Medical', '0', NULL, NULL, NULL, 1, 'Pending', NULL, '2025-09-17 05:43:56'),
(4, 'Suspicious Activity on Campus', 'Unknown person seen loitering near student dormitories after hours. Security investigation ongoing.', '2024-01-18', '22:30:00', 'University Campus, Dormitory Area', NULL, NULL, 'Medium', 'Security', '0', NULL, NULL, NULL, 4, 'Resolved', NULL, '2025-09-17 05:43:56'),
(5, 'Medical Emergency at Mall', 'Person collapsed in food court. CPR administered, ambulance called.', '2024-01-19', '15:20:00', 'City Mall, Food Court', NULL, NULL, 'High', 'Medical', '5', NULL, NULL, NULL, 1, 'Resolved', NULL, '2025-09-17 05:43:56'),
(6, 'Car Break-in Incident', 'Multiple vehicles broken into in parking garage. Items stolen from vehicles.', '2024-01-20', '06:00:00', 'Downtown Parking Garage', NULL, NULL, 'Medium', 'Security', '0', NULL, NULL, NULL, 2, 'Closed', NULL, '2025-09-17 05:43:56'),
(7, 'dasd', 'fsdf', '2025-09-17', '15:33:00', 'fdsfsd', NULL, NULL, 'Medium', 'Fire', '0', NULL, NULL, NULL, 6, 'Pending', NULL, '2025-09-17 07:34:08'),
(8, 'fdsf', 'fsdfdsfds', '2025-09-17', '15:35:00', 'fsdfsd', NULL, NULL, 'Low', 'Fire', '0', NULL, NULL, NULL, 6, 'Resolved', NULL, '2025-09-17 07:35:34'),
(9, 'fdsfds', 'fsdfsdfds', '2025-09-18', '17:42:00', 'fsdfsd', NULL, NULL, 'Low', 'Fire', '0', NULL, NULL, NULL, 1, 'Resolved', NULL, '2025-09-18 09:42:38'),
(10, 'fsdfsd', 'fsdfds', '2025-09-18', '17:43:00', 'fsdfsd', NULL, NULL, 'Medium', 'Fire', '0', NULL, NULL, NULL, 1, 'Resolved', NULL, '2025-09-18 09:44:10'),
(11, 'dfsdf', 'fsdfsdfsd', '2025-09-18', '17:57:00', 'fdsfds', NULL, NULL, 'Low', 'Fire', '0', NULL, NULL, NULL, 1, 'Resolved', NULL, '2025-09-18 09:57:33'),
(12, 'gfdgf', 'gfdgfd', '2025-09-18', '17:59:00', 'gfdgf', NULL, NULL, 'Low', 'Accident', '0', NULL, NULL, NULL, 1, 'Resolved', NULL, '2025-09-18 09:59:24'),
(13, 'gdfg', 'gdfgdfgfd', '2025-10-07', '18:48:00', 'gfdgf', NULL, NULL, 'Critical', 'Fire', '0', NULL, NULL, NULL, 3, 'Resolved', NULL, '2025-10-07 10:48:19'),
(14, 'gfdgdf', 'gdfgfdgfd', '2025-10-07', '19:05:00', 'gfdgdf', NULL, NULL, 'Critical', 'Security', '0', NULL, NULL, NULL, 3, 'Resolved', NULL, '2025-10-07 11:05:12'),
(17, 'fsdfsdf', 'fsdfdsfsd', '2025-10-07', '00:44:00', 'fdsfsd', NULL, NULL, 'Medium', 'Security', '0', NULL, NULL, NULL, 3, 'Pending', NULL, '2025-10-07 16:44:45'),
(18, 'sfsdfds', 'fsdfsdfsdf', '2025-10-11', '14:15:00', 'fsdfsdfsd', NULL, NULL, 'Medium', 'Medical', '0', NULL, NULL, NULL, 3, 'Pending', NULL, '2025-10-11 14:23:57'),
(19, 'sfsdfds', 'fsdfsdfsdf', '2025-10-11', '14:15:00', 'fsdfsdfsd', NULL, NULL, 'Medium', 'Medical', '0', NULL, NULL, NULL, 3, 'Pending', NULL, '2025-10-11 14:24:04'),
(20, 'sfsdfds', 'fsdfsdfsdf', '2025-10-11', '14:15:00', 'fsdfsdfsd', NULL, NULL, 'Medium', 'Medical', 'qweqweqweqw', NULL, NULL, NULL, 3, 'Pending', NULL, '2025-10-11 14:25:16'),
(21, 'fsfdsfsd', 'gdfgdfgdfgdff', '2025-10-11', '14:27:00', 'gdfgdfgdf', NULL, NULL, 'Low', 'Accident', 'gdfgdf', NULL, NULL, NULL, 3, 'Pending', NULL, '2025-10-11 14:27:15'),
(22, 'asdasdas', 'csdsadqweqw', '2025-10-11', '14:31:00', 'ddasdasdas', NULL, NULL, 'Medium', 'Accident', 'fdffsdfds', NULL, NULL, NULL, 3, 'Pending', NULL, '2025-10-11 14:32:07'),
(23, 'queuqwuieuiqwi', 'sfsdfsdfds', '2025-10-11', '14:40:00', 'qweqweqweqw', NULL, NULL, 'Critical', 'Fire', 'Hernan', NULL, NULL, NULL, 5, 'Resolved', NULL, '2025-10-11 14:40:38'),
(24, 'dhajskdhjka', 'fgfdgdgf', '2025-10-11', '14:43:00', 'dasdsasdas', NULL, NULL, 'Low', 'Fire', 'John', NULL, NULL, NULL, 5, 'Resolved', NULL, '2025-10-11 14:44:22'),
(25, 'qweqweqw', 'dasdasdas', '2025-10-11', '14:56:00', 'gfdgdfgdf', NULL, NULL, 'Medium', 'Accident', 'Jayson Decosta', NULL, NULL, NULL, 5, 'Resolved', NULL, '2025-10-11 14:56:16'),
(26, 'incident 1 sample', 'gfdgfdfgd', '2025-10-11', '15:04:00', 'eqweqweqw', NULL, NULL, 'Medium', 'Accident', 'Anjelly Fusingan', NULL, NULL, NULL, 5, 'Resolved', NULL, '2025-10-11 15:05:40'),
(27, 'fdsfsd', 'fdsfdsfsd', '2025-11-07', '04:09:00', 'fdsfdsf', NULL, NULL, 'High', 'Accident', 'vxcvcxvcx', NULL, NULL, NULL, 1, 'Resolved', NULL, '2025-11-07 04:09:28'),
(28, 'TEST', 'FDSFDS', '2025-11-07', '04:51:00', 'FDSFDSFSD', NULL, NULL, 'High', 'Fire', 'TEST', '09543412639', NULL, NULL, 1, 'Resolved', NULL, '2025-11-07 04:51:43'),
(29, 'test me pls', 'fgfdgdf', '2025-11-07', '04:58:00', 'gdfgdfgdf', NULL, NULL, 'High', 'Fire', 'test me pls', '09543412639', NULL, NULL, 1, 'Resolved', NULL, '2025-11-07 04:58:35'),
(30, 'ffdsfds', 'eqweqw', '2026-02-27', '06:45:00', 'Honorio Arriola Street, Cabe, Fishermen\'s Village, Bula, General Santos, Soccsksargen, 9500, Philippines', 6.12000000, 125.19000000, 'Critical', 'Accident', 'fdsfds', '09301791280', 'fsdfds', '09770372449', 6, 'Pending', NULL, '2026-02-27 06:45:46'),
(31, 'yetsxc', 'eqwewqewq', '2026-02-27', '06:47:00', 'Honorio Arriola Street, Cabe, Fishermen\'s Village, Bula, General Santos, Soccsksargen, 9500, Philippines', 6.12000000, 125.19000000, 'Critical', 'Fire', 'asdsadas', '09301791280', 'rwerew', '09770372449', 1, 'Resolved', NULL, '2026-02-27 06:47:20'),
(32, 'gfdgfdgfdg', 'dfgdfgfdgdf', '2026-02-27', '08:20:00', 'Mac Greggor Coffee House, Digos-Makar Road, Dadiangas East, General Santos, Soccsksargen, 9500, Philippines', 6.11850239, 125.17716730, 'Critical', 'Accident', 'fdgdfg', '09770372449', 'eqeq', '09770372449', 1, 'Resolved', NULL, '2026-02-27 08:20:16'),
(33, 'ewqewq', 'eqweqwe', '2026-02-27', '08:22:00', 'Honorio Arriola Street, Cabe, Fishermen\'s Village, Bula, General Santos, Soccsksargen, 9500, Philippines', 6.12000000, 125.19000000, 'Critical', 'Accident', 'fgdsds', '09770372449', 'adasd', '09770372449', 1, 'In Progress', NULL, '2026-02-27 08:22:11'),
(34, 'QWEQWEWQ', 'DASDASD', '2026-02-27', '08:25:00', 'Honorio Arriola Street, Cabe, Fishermen\'s Village, Bula, General Santos, Soccsksargen, 9500, Philippines', 6.12000000, 125.19000000, 'Medium', 'Security', 'EQWEWQ', '09770372449', 'FDF', '09770372449', 1, 'Resolved', 'dasdsadas', '2026-02-27 08:25:09');
...
(48, 29, 'Status changed from \'In Progress\' to \'Resolved\'', 2, '2026-02-27 06:46:33'),
(49, 31, 'Report approved by organization. Assigned priority number #8. Status set to In Progress. Assigned to: Cyrus teo.', 2, '2026-02-27 06:47:46'),
(50, 31, 'Status changed from \'In Progress\' to \'Resolved\'', 2, '2026-02-27 07:00:10'),
(51, 32, 'Report approved by organization. Assigned priority number #9. Status set to In Progress.', 2, '2026-02-27 08:20:30'),
(52, 32, 'Status changed from \'In Progress\' to \'Resolved\'', 2, '2026-02-27 08:21:00'),
(53, 33, 'Report approved by organization. Assigned priority number #10. Status set to In Progress. Assigned to: cyrus.', 2, '2026-02-27 08:23:24'),
(54, 34, 'Report approved by organization. Assigned priority number #11. Status set to In Progress. Assigned to: sai.', 2, '2026-02-27 08:26:29'),
(55, 34, 'Status changed from \'In Progress\' to \'Resolved\' by assigned member. Resolution reason: dasdsadas', 17, '2026-02-27 08:33:54');
...
(11, 30, 'fsdfd', '09456456452', '2026-02-27 06:45:46'),
(12, 31, 'gffd', '09554564567', '2026-02-27 06:47:20'),
(13, 32, 'dasdsa', '09770372449', '2026-02-27 08:20:16'),
(14, 33, 'adasds', '09770372449', '2026-02-27 08:22:11'),
(15, 34, 'SADASDASDA', '09770372449', '2026-02-27 08:25:09');
...
INSERT INTO `organizations` (`id`, `org_name`, `org_type`, `contact_number`, `address`, `latitude`, `longitude`, `created_at`) VALUES
(1, 'City General Hospital', 'Hospital', '09914996309', '123 Medical Center Dr, City, State 12345', NULL, NULL, '2025-09-17 05:43:56'),
(2, 'Metropolitan Police Department', 'Police', '09301791258', '456 Law Enforcement Ave, City, State 12345', NULL, NULL, '2025-09-17 05:43:56'),
(3, 'City Fire Department', 'Fire Department', '9603171069', '789 Fire Station Rd, City, State 12345', NULL, NULL, '2025-09-17 05:43:56'),
(4, 'University Security', 'Security', '09301791258', '321 Campus Blvd, City, State 12345', NULL, NULL, '2025-09-17 05:43:56'),
(5, 'Emergency Medical Services', 'Emergency Services', '09301791258', '654 Emergency Way, City, State 12345', NULL, NULL, '2025-09-17 05:43:56'),
(6, 'bvcbcv', 'Hospital', '9301791258', 'fdssd', NULL, NULL, '2025-09-17 07:15:06');
...
INSERT INTO `organization_members` (`id`, `organization_id`, `user_id`, `name`, `contact_number`, `email`, `login_username`, `login_password`, `created_at`) VALUES
(1, 1, 16, 'cyrus', '09770372449', 'cyrus@gmail.com', NULL, 'kcc', '2026-02-27 08:19:31'),
(2, 1, 17, 'sai', '09770372449', 'sai@gmail.com', NULL, 'kcc', '2026-02-27 08:26:14');
...
(22, 30, 6, 'Waiting', NULL, NULL, '2026-02-27 06:45:46', NULL),
(23, 31, 1, 'Approved', 8, 1, '2026-02-27 06:47:20', '2026-02-27 06:47:46'),
(24, 32, 1, 'Approved', 9, NULL, '2026-02-27 08:20:16', '2026-02-27 08:20:30'),
(25, 33, 1, 'Approved', 10, 1, '2026-02-27 08:22:11', '2026-02-27 08:23:24'),
(26, 34, 1, 'Approved', 11, 2, '2026-02-27 08:25:09', '2026-02-27 08:26:29');
...
(14, 'wright', 'wrighter@gmail.com', '$2y$10$8Nc35iza6DuPmkdnC6DxjO5pbJSucNmKlQGgDarFIDVa1oMwCwnAO', '', 1, '09770372449', '2026-02-27 08:16:41'),
(16, 'cyrus', 'cyrus@gmail.com', '$2y$10$HmryL0AQOiFtd1ZcY0AHl.PP7ShUxmvgCO2CjtMEGiMn25u9NYwMO', '', 1, '09770372449', '2026-02-27 08:19:31'),
(17, 'sai', 'sai@gmail.com', '$2y$10$K5Uo8v2W3UCgQn9vOuY.Lew7ca5pewXO8.1Z7btVgcYdpOzpZUVAK', 'Organization Member', 1, '09770372449', '2026-02-27 08:26:14');
COMMIT;
